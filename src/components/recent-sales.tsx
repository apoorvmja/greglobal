    ...
    return (
        <div className="space-y-8">
            ...
            <div className="flex items-center">
                ...
                <div className="ml-auto font-medium">{130 + verbal1Score}</div>
            </div>
            <div className="flex items-center">
                <Avatar className="h-9 w-9">
                ...
                <div className="ml-auto font-medium">{130 + verbal2Score}</div>
            </div>
            <div className="flex items-center">
                <Avatar className="h-9 w-9">
                ...
                <div className="ml-auto font-medium">{130 + quant1Score}</div>
            </div>
            <div className="flex items-center">
                <Avatar className="h-9 w-9">
                ...
                <div className="ml-auto font-medium">{130 + quant2Score}</div>
            </div>
        </div>
    );
}
